...
public class CashierController implements Initializable {
    ...
    @FXML private TableView<BillRow> itemsList;
    @FXML private TableColumn<BillRow, Integer> colNo;
    @FXML private TableColumn<BillRow, String> colItem;
    @FXML private TableColumn<BillRow, Double> colPrice;
    @FXML private TableColumn<BillRow, Double> colQty;
    @FXML private TableColumn<BillRow, Double> colTotal;
